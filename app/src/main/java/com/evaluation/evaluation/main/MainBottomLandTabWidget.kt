...
import com.evaluation.evaluation.databinding.LayoutMainBottomLandTabBinding
import com.evaluation.evaluation.main.floating.FloatingMenu
import com.google.android.material.floatingactionbutton.FloatingActionButton

class MainBottomLandTabWidget @JvmOverloads constructor(
    context: Context?,
    ...
    init { //默认第一个碎片
        val view =
            LayoutMainBottomLandTabBinding.inflate(LayoutInflater.from(context), this, true)
        view.apply {
